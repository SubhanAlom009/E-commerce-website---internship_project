            ...
            <motion.div
                ...
                <form onSubmit={handleSubmit} className='flex flex-col w-full m-auto'>
                    <div className='flex flex-col mb-4 font-mono'>
                        ...
                        <input className='px-2 py-2 outline-none focus:border focus:border-blue-700 rounded-xl ' value={fullname} onChange={(e)=>setFullname(e.target.value)} name='fullname' type="text" placeholder='name' />
                    </div>
                    <div className='flex flex-col mb-4 font-mono'>
                        <label className='mb-2'>Email Address</label>
                        <input className='px-2 py-2 outline-none focus:border focus:border-blue-700 rounded-xl ' value={email} onChange={(e)=>setEmail(e.target.value)} name='email' type="email" placeholder='Email' />
                    </div>
                    <div className='flex flex-col mb-4 font-mono'>
                        <label className='mb-2'>Password</label>
                        <input className='px-2 py-2 outline-none focus:border focus:border-blue-700 rounded-xl' value={password} onChange={(e)=>setPassword(e.target.value)} name='password' type="password" placeholder='password' />
                    </div>
